    ...
    @if(count($datosAgrupados) > 0)
        ...
        <div class="grand-total clearfix">
            <table>
                ...
                <tr> <th>Total Certificaciones Realizadas</th> <td>{{ number_format($totalesGenerales['registros'], 0, ',', '.') }}</td> </tr>
            </table>
        </div>
    @else
