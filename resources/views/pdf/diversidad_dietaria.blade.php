    ...
    @if(count($datosAgrupados) > 0)
        <table class="report-table">
            <thead><tr>
                ...
                <th width="25%" class="text-center">Encuestas Realizadas</th>
                <th width="25%" class="text-right">Total Personas Abordadas</th>
            </tr></thead>
            <tbody>
        ...
        <div class="grand-total clearfix"><table>
            ...
            <tr><th>Total Encuestas</th><td>{{ number_format($totalesGenerales['registros'],0,',','.') }}</td></tr>
            <tr><th>Total Personas Abordadas</th><td>{{ number_format($totalesGenerales['cantidad'],0,',','.') }}</td></tr>
        </table></div>
    @else
