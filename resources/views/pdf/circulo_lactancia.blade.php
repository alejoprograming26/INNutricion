    ...
    @if(count($datosAgrupados) > 0)
        <table class="report-table">
            <thead>
                <tr>
                    ...
                    <th width="25%" class="text-center">Registros</th>
                    <th width="25%" class="text-right">Total Atenciones</th>
                </tr>
            </thead>
            <tbody>
        ...
        <div class="grand-total clearfix">
            <table>
                ...
                <tr> <th>Registros Realizados</th> <td>{{ number_format($totalesGenerales['registros'], 0, ',', '.') }}</td> </tr>
                <tr> <th>Total Atenciones</th> <td>{{ number_format($totalesGenerales['cantidad'], 0, ',', '.') }}</td> </tr>
            </table>
        </div>
    @else
