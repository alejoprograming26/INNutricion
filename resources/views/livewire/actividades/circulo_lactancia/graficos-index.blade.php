<div class="mb-6">
    ...
    <div
        ...
        <div class="flex items-center gap-4">
            <div
                class="w-10 h-10 rounded-xl bg-teal-100 dark:bg-teal-500/10 flex items-center justify-center border border-teal-200 dark:border-teal-500/20">
                <flux:icon.chart-pie class="w-6 h-6 text-teal-600 dark:text-teal-400" />
            </div>
            <div>
                <h1 class="text-2xl font-bold text-zinc-800 dark:text-zinc-100 tracking-tight">Dashboard: Círculo de
                    Lactancia</h1>
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <flux:button icon="arrow-left" variant="subtle" href="{{ route('admin.actividades.circulo.index') }}"
                wire:navigate>
                Volver a Tabla
            </flux:button>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <div
            ...
            <div
                class="absolute -right-6 -top-6 w-24 h-24 bg-teal-500/10 rounded-full blur-2xl group-hover:bg-teal-500/20 transition-all duration-500">
            </div>
            <div class="flex justify-between items-start relative z-10">
                ...
                <div
                    class="w-10 h-10 rounded-full bg-teal-100 dark:bg-teal-500/10 flex items-center justify-center border border-teal-200 dark:border-teal-500/20 text-teal-600 dark:text-teal-400">
        ...
        <div
            class="bg-white dark:bg-zinc-900 rounded-3xl p-6 border border-zinc-100 dark:border-zinc-800/80 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.1)] relative overflow-hidden group">
            <div
                class="absolute -right-6 -top-6 w-24 h-24 bg-cyan-500/10 rounded-full blur-2xl group-hover:bg-cyan-500/20 transition-all duration-500">
            </div>
            <div class="flex justify-between items-start relative z-10">
                <div>
                ...
                <div
                    class="w-10 h-10 rounded-full bg-cyan-100 dark:bg-cyan-500/10 flex items-center justify-center border border-cyan-200 dark:border-cyan-500/20 text-cyan-600 dark:text-cyan-400">
                ...
                <div class="w-full">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="w-full bg-zinc-100 dark:bg-zinc-800 h-2 rounded-full overflow-hidden">
                            <div class="bg-gradient-to-r from-teal-500 to-cyan-500 h-full rounded-full"
                                style="width: 80%"></div>
                        </div>
                    </div>
                </div>
