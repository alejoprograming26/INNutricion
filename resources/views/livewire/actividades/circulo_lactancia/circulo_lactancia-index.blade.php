                        ...
                        <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors text-center">
                            ...
                            <td class="px-3 py-3">
                                <div class="flex items-center justify-center gap-2">
                                    <flux:button wire:click="openReportModal({{ $m->id }}, 'grafico')" size="sm" icon="chart-bar" class="!bg-violet-600 !text-white border-none hover:!bg-violet-700 font-bold" title="Ver Gráficas">Gráficas</flux:button>
