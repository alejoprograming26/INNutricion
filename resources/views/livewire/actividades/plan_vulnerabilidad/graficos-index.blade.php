<div class="mb-6">
    ...
    <div
        ...
        <div class="flex items-center gap-4">
            <div
                class="w-10 h-10 rounded-xl bg-rose-100 dark:bg-rose-500/10 flex items-center justify-center border border-rose-200 dark:border-rose-500/20">
                <flux:icon.chart-pie class="w-6 h-6 text-rose-600 dark:text-rose-400" />
            </div>
            <div>
                <h1 class="text-2xl font-bold text-zinc-800 dark:text-zinc-100 tracking-tight">Dashboard: Plan
                    Vulnerabilidad</h1>
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <flux:button icon="arrow-left" variant="subtle" href="{{ route('admin.actividades.vulnerabilidad.index') }}"
                wire:navigate>
                Volver a Tabla
            </flux:button>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <div
            ...
            <div
                class="absolute -right-6 -top-6 w-24 h-24 bg-rose-500/10 rounded-full blur-2xl group-hover:bg-rose-500/20 transition-all duration-500">
            </div>
            <div class="flex justify-between items-start relative z-10">
                ...
                <div
                    class="w-10 h-10 rounded-full bg-rose-100 dark:bg-rose-500/10 flex items-center justify-center border border-rose-200 dark:border-rose-500/20 text-rose-600 dark:text-rose-400">
        ...
        <div
            class="bg-white dark:bg-zinc-900 rounded-3xl p-6 border border-zinc-100 dark:border-zinc-800/80 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.1)] relative overflow-hidden group">
            <div
                class="absolute -right-6 -top-6 w-24 h-24 bg-red-500/10 rounded-full blur-2xl group-hover:bg-red-500/20 transition-all duration-500">
            </div>
            <div class="flex justify-between items-start relative z-10">
                <div>
                    <p class="text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-widest mb-1">
                ...
                <div
                    class="w-10 h-10 rounded-full bg-red-100 dark:bg-red-500/10 flex items-center justify-center border border-red-200 dark:border-red-500/20 text-red-600 dark:text-red-400">
                ...
                <div class="w-full">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="w-full bg-zinc-100 dark:bg-zinc-800 h-2 rounded-full overflow-hidden">
                            <div class="bg-gradient-to-r from-rose-500 to-red-500 h-full rounded-full"
                                style="width: 82%"></div>
                        </div>
                    </div>
                </div>
    ...
    @script
        <script>
            ...
            const initCharts = () => {
                ...
                if (ctxT && $wire.graphTipos && $wire.graphTipos.length) {
                    chartInstances.tipos = new Chart(ctxT, {
                        type: 'doughnut',
                        data: {
                            labels: $wire.graphTipos.map(t => t.nombre),
                            datasets: [{
                                data: $wire.graphTipos.map(t => t.total),
                ...
                if (ctxS && dataSectores.length) {
                    chartInstances.sectores = new Chart(ctxS, {
                        type: 'bar',
                        data: {
                            labels: dataSectores.slice(0, 15).map(d => d.nombre.substring(0, 15)),
                            datasets: [{
                                label: 'Entregas',
