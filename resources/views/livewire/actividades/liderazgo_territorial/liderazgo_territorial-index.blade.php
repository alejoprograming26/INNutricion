            ...
            <div class="bg-white dark:bg-zinc-900 w-full max-w-4xl rounded-2xl shadow-2xl flex flex-col max-h-[90vh] border border-zinc-200 dark:border-zinc-800 overflow-hidden">
                <div class="px-6 py-5 border-b border-zinc-200 dark:border-zinc-800 flex items-center justify-between">
                    <h2 class="text-lg font-black text-zinc-800 dark:text-zinc-100">
                        {{ $liderazgo_id ? 'Editar Formación' : 'Nueva Formación' }}
                    </h2>
                ...
                <div class="p-6 overflow-y-auto bg-zinc-50/50 dark:bg-zinc-900/50">
                    <form wire:submit="store" id="liderazgoForm" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <flux:input wire:model="cantidad" type="number" min="1" label="Cantidad de Personas *" placeholder="0" required />
                ...
                <div class="px-6 py-4 border-t border-zinc-200 dark:border-zinc-800 flex justify-end gap-3">
                    ...
                    <flux:button type="submit" form="liderazgoForm" class="!bg-gradient-to-r !from-lime-600 !to-emerald-600 hover:!from-lime-500 hover:!to-emerald-500 !text-zinc-900 border-none font-bold shadow-md shadow-lime-500/20">
            ...
            <div class="bg-white dark:bg-zinc-900 w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden border border-zinc-200 dark:border-zinc-800">
                ...
                <div class="px-6 pb-6 -mt-8">
                    <div class="w-16 h-16 rounded-2xl bg-white dark:bg-zinc-800 flex items-center justify-center shadow-lg mb-4 border-4 border-white dark:border-zinc-900">
                        <flux:icon.users class="w-8 h-8 text-emerald-600" />
                    </div>
                    
                    <h2 class="text-2xl font-black text-zinc-800 dark:text-zinc-100">{{ $view_tema_tratado }}</h2>
                    ...
                    <div class="mt-6 flex items-center justify-between p-4 rounded-xl bg-lime-50 dark:bg-lime-500/10 border border-lime-100 dark:border-lime-500/20">
                        <span class="text-sm font-bold uppercase tracking-wider text-lime-700 dark:text-lime-400">Personas Formadas</span>
