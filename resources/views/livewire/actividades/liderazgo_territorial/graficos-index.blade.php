<div class="mb-6">
    ...
    <div
        ...
        <div class="flex items-center gap-4">
            <div
                class="w-10 h-10 rounded-xl bg-sky-100 dark:bg-sky-500/10 flex items-center justify-center border border-sky-200 dark:border-sky-500/20">
                <flux:icon.chart-pie class="w-6 h-6 text-sky-600 dark:text-sky-400" />
            </div>
            <div>
                <h1 class="text-2xl font-bold text-zinc-800 dark:text-zinc-100 tracking-tight">Dashboard: Liderazgo
                    Territorial</h1>
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <flux:button icon="arrow-left" variant="subtle" href="{{ route('admin.actividades.liderazgo.index') }}"
                wire:navigate>
                Volver a Tabla
            </flux:button>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <div
            ...
            <div
                class="absolute -right-6 -top-6 w-24 h-24 bg-sky-500/10 rounded-full blur-2xl group-hover:bg-sky-500/20 transition-all duration-500">
            </div>
            <div class="flex justify-between items-start relative z-10">
                <div>
                    ...
                    <p class="text-xs text-sky-600 dark:text-sky-400 mt-2 flex items-center gap-1 font-medium">
                        <flux:icon.check-circle class="w-3 h-3" /> Empoderamiento territorial
                    </p>
                </div>
                <div
                    class="w-10 h-10 rounded-full bg-sky-100 dark:bg-sky-500/10 flex items-center justify-center border border-sky-200 dark:border-sky-500/20 text-sky-600 dark:text-sky-400">
        ...
        <div
            class="bg-white dark:bg-zinc-900 rounded-3xl p-6 border border-zinc-100 dark:border-zinc-800/80 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.1)] relative overflow-hidden group">
            <div
                class="absolute -right-6 -top-6 w-24 h-24 bg-blue-500/10 rounded-full blur-2xl group-hover:bg-blue-500/20 transition-all duration-500">
            </div>
            <div class="flex justify-between items-start relative z-10">
                <div>
                    ...
                    <p class="text-xs text-zinc-500 dark:text-zinc-400 mt-2 font-medium">Encuentros realizados</p>
                </div>
                <div
                    class="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-500/10 flex items-center justify-center border border-blue-200 dark:border-blue-500/20 text-blue-600 dark:text-blue-400">
        ...
        <div
            ...
            <div class="flex justify-between items-start relative z-10">
                <div>
                    ...
                    <p class="text-xs text-zinc-500 dark:text-zinc-400 mt-2 font-medium">Líderes por día</p>
                </div>
                <div
                    class="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-500/10 flex items-center justify-center border border-blue-200 dark:border-blue-500/20 text-blue-600 dark:text-blue-400">
                ...
                <div class="w-full">
                    ...
                    <div class="mt-3">
                        <div class="flex justify-between items-end mb-1">
                            <span class="text-2xl font-black text-zinc-800 dark:text-zinc-100">Diverso</span>
                            <span class="text-xs font-bold text-sky-600 dark:text-sky-400">Multitemático</span>
                        </div>
                        <div class="w-full bg-zinc-100 dark:bg-zinc-800 h-2 rounded-full overflow-hidden">
                            <div class="bg-gradient-to-r from-sky-500 to-blue-500 h-full rounded-full"
                                style="width: 75%"></div>
                        </div>
                    </div>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        <div
            ...
            <h3
                ...
                <flux:icon.map class="w-4 h-4 text-sky-500" />
        ...
        <div
            ...
            <h3
                class="text-sm font-bold text-zinc-800 dark:text-zinc-200 uppercase tracking-wider mb-4 flex items-center gap-2">
                <flux:icon.chart-bar-square class="w-4 h-4 text-sky-500" />
                Formaciones Diarias
            </h3>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        <div
            ...
            <h3
                class="text-sm font-bold text-zinc-800 dark:text-zinc-200 uppercase tracking-wider mb-4 flex items-center gap-2">
                <flux:icon.building-office class="w-4 h-4 text-sky-500" />
                Comunas Impactadas
            </h3>
        ...
        <div
            ...
            <h3
                class="text-sm font-bold text-zinc-800 dark:text-zinc-200 uppercase tracking-wider mb-4 flex items-center gap-2">
                <flux:icon.map-pin class="w-4 h-4 text-sky-500" />
                Sectores con Líderes
            </h3>
            <div class="flex-1 relative w-full min-h-[400px]" wire:ignore>
